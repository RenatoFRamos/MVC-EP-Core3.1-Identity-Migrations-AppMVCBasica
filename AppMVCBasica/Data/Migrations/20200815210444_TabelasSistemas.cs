    ...
    public partial class TabelasSistemas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Forcenedores", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enderecos_Forcenedores_FornecedorId",
                        column: x => x.FornecedorId,
                        principalTable: "Forcenedores",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Produtos_Forcenedores_FornecedorId",
                        column: x => x.FornecedorId,
                        principalTable: "Forcenedores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
