...
namespace AppMVCBasica.Controllers
{
    ...
    public class FornecedoresController : Controller
    {
        ...
        {
            return View(await _context.Forcenedores.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var fornecedor = await _context.Forcenedores
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            var fornecedor = await _context.Forcenedores.FindAsync(id);
            if (fornecedor == null)
            {
                return NotFound();
            }
        ...
        {
            var fornecedor = await _context.Forcenedores.FindAsync(id);
            _context.Forcenedores.Remove(fornecedor);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Forcenedores.Any(e => e.Id == id);
        }
    }
}
